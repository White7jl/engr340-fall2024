...
##geometry rectangular & material is an unknown steel
...
#Find area we know that the shape is rectangular
area = width*thickness        #in in^2
...
print("This is yield stress",yield_stress)
print("This is yield strain", yield_strain)
...
"I determined the area. Then I used the load data and the area to determine stress and used the extension data and "
...
"under the curve to their respective points. I created a graph for the stress-strain curve and offset line and"
...
print("This is the Modulus of Toughness", MT, "ksi")
print("This is the Modulus of Resilience", Ur, "ksi")
