...
def main(full_path_to_file):
    ...
    #baseline_avg = calculate_avg(baseline_data) requires def
    ...
    baseline_length2 = 20              ##Where in the data
    ...
    force_plate_list_flight = force_plate.tolist()
    ...
    # since we know the take off point will be afterwards.
        ...
        ### your code here ###
    for index in range(first_landing_index, len(force_plate_list)):
            value = force_plate_list[index]
    ...
    # walk through the list but start a few moment after the takeoff point
        ### your code here ###
    for index in range(take_off_index,len(force_plate_list)):
            value = force_plate_list[index]
